...
/**
 * Tema único de la app. El paciente puede forzar modo oscuro desde Configuración
 * (E13 del backlog); [forceDarkTheme] es el override, null = seguir al sistema.
 */
@Composable
fun AnxietyWatchTheme(
    ...
    val useDark = forceDarkTheme ?: isSystemInDarkTheme()
    MaterialTheme(
